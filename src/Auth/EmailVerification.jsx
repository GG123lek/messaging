    ...
    <div className="min-h-screen flex flex-col" style={backgroundStyle}>
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          ...
          <p className="text-gray-800">We sent a verification code to <strong>Mayowahope@gmail.com</strong></p>
          ...
          <p className="text-center text-sm text-gray-600">
            Didn't get the email? <button className="text-blue-600 hover:underline">Resend code</button>
          </p>
        </div>
      </div>
    </div>
