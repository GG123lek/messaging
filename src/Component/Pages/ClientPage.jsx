...
function ClientPage() {
  ...
  // Check if the current path includes 'customer-form'
    ...
    <div>
      ...
      <main className="p-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-[#101828] mb-1">
              {isNewCustomer ? 'New Customer' : 'Clients'}
            </h1>
          ...
          {!isNewCustomer && (
            <button
              ...
              className="flex items-center gap-2 bg-[#2292FC] text-white text-sm font-medium px-4 py-2 rounded-md shadow-sm hover:bg-[#1b7ed1] transition"
            >
          ...
          {isNewCustomer && (
            <button
              ...
              className="text-[#2292FC] underline text-sm font-medium"
            >
              Back to Clients
            </button>
          )}
        ...
        {/* Show BankClientsTable only if NOT on new customer form */}
        {!isNewCustomer && <BankClientsTable />}
